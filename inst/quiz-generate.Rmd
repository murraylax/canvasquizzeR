...
params:
  ...
  includeanswers: TRUE
  seed: 1
  student_first_name: "Extra"
  student_last_name: "Student"
  student_username: "extra1"
...
student_first_name: "`r params$student_first_name`"
student_last_name: "`r params$student_last_name`"
student_first_name_url: "`r URLencode(params$student_first_name)`"
student_last_name_url: "`r URLencode(params$student_last_name)`"
student_username: "`r params$student_username`"
exam_file_title_nospace: "`r params$exam_file_title_nospace`"
...
print_question <- function(questionj, includeanswers, version="a")
{
  ...
  if(str_simplify(question_type)=="essay") {
    ...
    question_str <- sprintf("(%d points) %s \n\n", questionj$Points, question_str)
    cat(question_str)
